...
namespace VSM.Class
{
    public class IO
    {
        ...
        public bool delete(String source, String destination)
        {
            try
            {
                if (File.Exists(source))
        ...
        public String[] getFolderNames(String Source)
        {
            try
            {
        ...
        public String[] getFileNames(String Source)
        {
            try
            {
        ...
        public bool Upload(FileUpload docs, String limit = null)
        {
            if (docs.HasFile)
            {
                try
