    ...
    <div class="container-fluid">
        ...
        col-sm-12">
                        <div class="card card-comman mt-5">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-7 col-sm-12 col-md-12 d-flex justify-content-left">
                                        <h1 class="text-info">
                                            <asp:Label ID="Label3" runat="server" Text="Label">Share Name</asp:Label>
                                        </h1>
                                    </div>
                                    <div class="col-lg-5 col-sm-12 col-md-12 d-flex justify-content-left ml-auto">
                                        ...
                                        <table class="table" cellspacing="5px">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="Label5" runat="server" Text="Label" CssClass="ml-5"></asp:Label>
                                                    </td>
                                                    <td>
